...
HistorySearchTool::RequiresUserInteractionBeforeHandling(
  ...
  return mojom::PermissionChallenge::New(
      std::nullopt,
      "Brave AI wants to search your browsing history. The search runs "
      "locally on your device, so your full history isn't sent anywhere. "
      "Only the matching pages' titles, URLs, and indexed text passages "
      "will be sent to Brave AI as part of this conversation.");
}
