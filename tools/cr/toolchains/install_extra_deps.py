...
EXTRA_DEPS = {
    'src/third_party/rust-toolchain': {
        ...
        'objects': [
            {
                'object_name': 'linux-x64-rust-toolchain-4c4205163abcbd08948b3efab796c543ba1ea687-4-llvmorg-23-init-10931-g20b6ec66-1.tar.xz',
                'sha256sum': '9653899d0cc6f48925121cdd71e687f03093647fdff65db90539309f37771b51',
                'overlayed_on': 'Linux_x64/rust-toolchain-4c4205163abcbd08948b3efab796c543ba1ea687-4-llvmorg-23-init-10931-g20b6ec66.tar.xz',
                'condition': 'host_os == "linux"',
            },
            {
                'object_name': 'mac-arm64-rust-toolchain-4c4205163abcbd08948b3efab796c543ba1ea687-4-llvmorg-23-init-10931-g20b6ec66-1.tar.xz',
                'sha256sum': '475f12e5dc4d73485364b269f6c80c21ceacf66ffc5cbfd5ff614ea859ee2ccf',
                'overlayed_on': 'Mac_arm64/rust-toolchain-4c4205163abcbd08948b3efab796c543ba1ea687-4-llvmorg-23-init-10931-g20b6ec66.tar.xz',
                'condition': 'host_os == "mac" and host_cpu == "arm64"',
            },
            {
                'object_name': 'mac-rust-toolchain-4c4205163abcbd08948b3efab796c543ba1ea687-4-llvmorg-23-init-10931-g20b6ec66-1.tar.xz',
                'sha256sum': 'c468470e425914ee0ea38c6892dd5da96dec671b535e85bb83223b0bb6b451ec',
                'overlayed_on': 'Mac/rust-toolchain-4c4205163abcbd08948b3efab796c543ba1ea687-4-llvmorg-23-init-10931-g20b6ec66.tar.xz',
                'condition': 'host_os == "mac" and host_cpu == "x64"',
            },
            {
                'object_name': 'win-rust-toolchain-4c4205163abcbd08948b3efab796c543ba1ea687-4-llvmorg-23-init-10931-g20b6ec66-1.tar.xz',
                'sha256sum': 'dacb5123a9ef590c39d4e04fc0992882d9a01fb209394a75be7e75df53edf9c6',
                'overlayed_on': 'Win/rust-toolchain-4c4205163abcbd08948b3efab796c543ba1ea687-4-llvmorg-23-init-10931-g20b6ec66.tar.xz',
...
def _extract(archive_path: Path, dest_dir: Path) -> None:
    ...
    For the first case that this script is being used, the Rust/WASM toolchain,
    at the moment, we only package a partial volume of the toolchain, whilst
    letting Google deploy the full toolchain package via GCS. This approach
    means we don't actually own the deployment path, so we just overlay our
    files on top. This was part of the original design for the WASM toolchain,
    and it is something that we may decide to change at some point. In the
    meantime, we leave it to the archive's internal layout the determinatio of
    where extracted files should go in the existing path.
