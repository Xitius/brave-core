...
void LoggedOutState::ResendConfirmationEmailLoggedOut(
    mojom::LoggedOutVerificationIntent intent,
    ResendConfirmationEmailLoggedOutCallback callback) {
  ResendConfirmationEmail(mojom::VerificationIntent::NewLoggedOutIntent(intent),
                          std::move(callback));
}

void LoggedOutState::CancelVerificationLoggedOut(
    mojom::LoggedOutVerificationIntent intent) {
  CancelVerification(mojom::VerificationIntent::NewLoggedOutIntent(intent));
